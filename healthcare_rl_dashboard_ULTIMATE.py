...
def generate_pdf(patient):
    """
    Creates a simple text report instead of PDF.
    Streamlit Cloud doesn't support ReportLab.
    """
    report = "Healthcare Patient Report\n\n"
...
st.download_button(
    ...
    data=report_data,
    file_name=f"patient_{pid}_report.txt",
    mime="text/plain"
)
